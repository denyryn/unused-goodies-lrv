    ...
    <div class="navbar text-theme-invert">
        ...
        <div class="navbar-end space-x-1">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="btn btn-ghost ">
                        <img class="size-5 dark:invert" src="{{ \App\Utilities\Asset::getFromAssets('Icons/user.svg') }}" alt="User Login">
                    </a>
                @endif
            </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex btn btn-ghost items-center justify-center p-2 rounded-md text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:text-gray-900 dark:focus:text-gray-100 transition duration-150 ease-in-out">
