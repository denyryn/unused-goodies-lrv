...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <div class="navbar bg-base-100 text-theme-invert">
        ...
        <div class="navbar-end space-x-1">
            @if (\App\Utilities\Permission::isUserLoggedIn() && !(\App\Utilities\Permission::isAdmin()))
                <a class="flex bg-transparent border-none shadow-none outline-none btn btn-ghost text-gray-800 dark:text-gray-100">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if (\App\Utilities\Permission::isAdmin() && Laravel\Jetstream\Jetstream::hasApiFeatures())
            ...
            <!-- <a href="{{ route('profile.show') }}"
                ...
                <img class="w-5 h-5" src="{{ asset('assets/Icons/kebab.svg') }}" alt="Login">
            </a> -->
